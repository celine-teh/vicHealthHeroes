...
$cfg['blowfish_secret']					= '_\\\"(F<y}iVK@B/5n5fc5`B7<c+UPA_|J' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_xJGOXuvRIktwYSA9K3yZila/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
